...
public class imagePrintingActivity extends Activity implements OnItemSelectedListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        CheckBox checkbox_bitImage_generateAPI = (CheckBox)findViewById(R.id.checkbox_bitImage_generateAPI);
		...
		checkbox_bitImage_generateAPI.setChecked(true);
	}
	...
	public void PrintText(View view)
	{
        ...
        CheckBox checkbox_bitImage_generateAPI = (CheckBox)findViewById(R.id.checkbox_bitImage_generateAPI);
		if(checkbox_bitImage_generateAPI.isChecked() == true)
		{
