...
public class cutActivity extends Activity
{
	...
	public void FullCut(View view)
	{
		...
		PrinterFunctions.PreformCut(this, portName, portSettings, CutType.FULL_CUT);
	}
	
	public void ParcialCut(View view)
	{
		String portName = PrinterTypeActivity.getPortName();
		String portSettings = PrinterTypeActivity.getPortSettings();
		
		PrinterFunctions.PreformCut(this, portName, portSettings, CutType.PARTIAL_CUT);
	}
	...
	public void FullCutWithFeed(View view)
	{
		...
		PrinterFunctions.PreformCut(this, portName, portSettings, CutType.FULL_CUT_FEED);
	}
	
	public void ParcialCutWithFeed(View view)
	{
		String portName = PrinterTypeActivity.getPortName();
		String portSettings = PrinterTypeActivity.getPortSettings();
		
		PrinterFunctions.PreformCut(this, portName, portSettings, CutType.PARTIAL_CUT_FEED);
	}
