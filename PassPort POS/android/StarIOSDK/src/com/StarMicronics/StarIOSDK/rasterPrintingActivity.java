...
public class rasterPrintingActivity extends Activity implements OnItemSelectedListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        CheckBox checkbox_generateAPI = (CheckBox)findViewById(R.id.checkbox_generateAPI);
        CheckBox checkbox_pageMode = (CheckBox)findViewById(R.id.checkbox_pageMode);

        checkbox_generateAPI.setChecked(true);
	...
	public void PrintText(View view)
	{
        ...
        CheckBox checkbox_generateAPI = (CheckBox)findViewById(R.id.checkbox_generateAPI);
		if(checkbox_generateAPI.isChecked() == true)
		{
		...
		{
			PrinterFunctions.PrintBitmap(this, portName, portSettings, bitmap, paperWidth, compressionEnable, false);
		}
	}
