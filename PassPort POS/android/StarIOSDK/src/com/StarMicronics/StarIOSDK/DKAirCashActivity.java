...
public class DKAirCashActivity extends Activity{
	...
	private StarIOPort drawerport = null;
	private static StarIOPort drawerdialogport = null;
    ...
    public void OpenCashDrawer(View view)
    {
    	...
    	EditText drawerportNameField = (EditText)findViewById(R.id.editText_DrawerPortName);
    	final String portName = drawerportNameField.getText().toString();
...
class DrawerOpenThread extends Thread {
    ...
    public void run () {
    	//GetPort
    	try {
    		port1 = StarIOPort.getPort(portName, portSettings, 10000, me);
		} catch ( StarIOPortException e) {
