...
import com.pos.passport.util.KeyboardGridUtils;
...
public class KeyboardGridView extends GridView {
    ...
    public KeyboardGridView(Context context, AttributeSet attrs, int defStyle) {
    ...
    private KeyboardGridInterface getAdapterInterface() {
        return ((KeyboardGridInterface) getAdapter());
    }
    ...
    private void handleCellSwitch() {
        ...
        for (Long id : idList) {
            ...
            if (view != null) {
                ...
                if ((aboveRight(targetColumnRowPair, mobileColumnRowPair)
                    ...
                    float xDiff = Math.abs(KeyboardGridUtils.getViewX(view) - KeyboardGridUtils.getViewX(mMobileView));
                    float yDiff = Math.abs(KeyboardGridUtils.getViewY(view) - KeyboardGridUtils.getViewY(mMobileView));
        ...
        if (targetView != null) {
            ...
            final KeyboardGridInterface adapter = getAdapterInterface();
