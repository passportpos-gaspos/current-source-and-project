...
/**
 * Created by Kareem on 4/20/2016.
 */
@SuppressLint("RestrictedApi")
public class PopupMenuView implements MenuBuilder.Callback, MenuPresenter.Callback {
    ...
    public interface OnDismissListener {
         ...
         */
        public void onDismiss(PopupMenuView menu);
    }
    ...
    public PopupMenuView(Context context, View anchor) {
        ...
        mAnchor = anchor;
        mPopup = new MenuPopupHelper(wrapper, mMenu, anchor);
