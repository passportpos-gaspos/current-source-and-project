...
public class OldShopCart {
	...
	public void AddProduct(Product test1) {
		Products.add(test1);
	}
...
public String getBody() {
		...
		if(!(StoreSetting.getAddress1().equals(""))){
			receiptString.append(EscPosDriver.wordWrap(StoreSetting.getAddress1(), cols+1)).append("<br>");
		}
