 ...
 */
public class TenPadDialogFragment extends DialogFragment
{
    ...
    private View.OnClickListener mOkClickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            if (mType == TEN_PAD_TYPE_ADMIN) {
                ...
                if(mValue != null && mCashier!=null && mValue.toString().equals(mCashier.pin)){
                    mTenPadListener.onAdminAccessGranted();
                }else{
                    mDisplayTextView.setError(getString(R.string.txt_invalid_pin));
                    mPasswordEditView.setError(getString(R.string.txt_invalid_pin));
    ...
    public static TenPadDialogFragment newInstance(@TenPadType int tenPadType) {
        TenPadDialogFragment f = new TenPadDialogFragment();
    ...
    public static TenPadDialogFragment newInstance(@TenPadType int tenPadType, @NonNull Cashier cashier){
        TenPadDialogFragment f = new TenPadDialogFragment();
    ...
    public static TenPadDialogFragment newInstance(@TenPadType int tenPadType, BigDecimal amount) {
        TenPadDialogFragment f = new TenPadDialogFragment();
    ...
    public static TenPadDialogFragment newInstance(@TenPadType int tenPadType, BigDecimal maxAmount, BigDecimal price) {
        TenPadDialogFragment f = new TenPadDialogFragment();
    ...
    public static TenPadDialogFragment newInstance(@TenPadType int tenPadType, BigDecimal maxAmount, BigDecimal price, @Product.ModifierType int discountType) {
        TenPadDialogFragment f = new TenPadDialogFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        else v = inflater.inflate(R.layout.fragment_ten_pad_frame, container, false);
