 ...
 * {@link com.google.zxing.BarcodeFormat#PDF_417}. Use {@link #initiateScan(Collection)} with
    ...
    private AlertDialog showDownloadDialog() {
        ...
        downloadDialog.setPositiveButton(buttonYes, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                //BB10 BlackBerry World
                //Uri uri = Uri.parse("market://search?id=Zxing");

                //Amazon Market
                //Uri uri = Uri.parse("http://www.amazon.com/gp/mas/dl/android?p=" + BS_PACKAGE);
                ...
                try {
                    ...
                    Log.w(TAG, "Amazon marketplace is not installed; cannot install Barcode Scanner");
