 ...
 */
public class DeleteHardwareAsyncTask extends AsyncTask<String, String, String> {
    ...
    public DeleteHardwareAsyncTask(Context context, boolean showMessage, String type, JSONObject sendata) {
        ...
        if(type.equalsIgnoreCase(Consts.DELETEPRINTER_TEXT))
            mUrl=UrlProvider.BASE_INNER+UrlProvider.DELETE_PRINTER;
        else
            mUrl=UrlProvider.BASE_INNER+UrlProvider.DELETE_CARD_READER;
    ...
    protected String doInBackground(String[] params) {
        try {
            ...
            //Log.d("postdata","Postdata >>>>"+mUrl);
            String mpsResponse = Utils.DeletePrinterOrCardData(mUrl, postdata);
            return mpsResponse;
        } catch (Exception e) {
            e.printStackTrace();
        }
