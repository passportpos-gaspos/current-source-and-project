...
/**
 * Created by karim on 10/27/15.
 */
public class BasicItemAnimator extends SimpleItemAnimator {
    ...
    private void animateChangeImpl(final ChangeInfo changeInfo) {
        ...
        if (view != null) {
            ...
            oldViewAnim.alpha(0).setListener(new VpaListenerAdapter() {
                ...
                public void onAnimationEnd(View view) {
                    ...
                    ViewCompat.setAlpha(view, 1);
                    ViewCompat.setTranslationX(view, changeInfo.oldHolder.itemView.getWidth());
                    ViewCompat.setTranslationY(view, 0);
        ...
        if (newView != null) {
            ...
            newViewAnimation.translationX(0 - changeInfo.newHolder.itemView.getWidth()).translationY(0).setDuration(getChangeDuration()).
